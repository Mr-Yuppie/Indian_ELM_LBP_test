...
% Elm_Type                    - 0 for regression; 
%  0是回归，1是分类              1 for (both binary and multi-classes) classification
% Regularization_coefficient  - Regularization coefficient C 正则化系数
...
%  正确率                       RMSE for regression or correct classification rate for classification
% TestingAccuracy             - Testing accuracy: 
%                               RMSE for regression or correct classification rate for classification
%
% MULTI-CLASSE CLASSIFICATION: NUMBER OF OUTPUT NEURONS WILL BE AUTOMATICALLY SET EQUAL TO NUMBER OF CLASSES
% 多分类分类：输出神经元的数量将自动等同于类别数
% FOR EXAMPLE, if there are 7 classes in all, there will have 7 output
%  FOR示例，如果共有7个类，则将有7个输出
% neurons; neuron 5 has the highest output means input belongs to 5-th class
% 神经元; 神经元5具有最高的输出意味着输入属于第5类
